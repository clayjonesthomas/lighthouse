...
export const ADD_ONLY_PICKED_SHOPS_CHANGE = 'ADD_ONLY_PICKED_SHOPS_CHANGE'
...
export const addOnlyPickedShopsChange = (addedShop) => {
  return {
    type: ADD_ONLY_PICKED_SHOPS_CHANGE,
    data: addedShop
  }
}
